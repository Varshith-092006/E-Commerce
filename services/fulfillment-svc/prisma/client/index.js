...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "services/fulfillment-svc/prisma/client",
    "fulfillment-svc/prisma/client",
  ]
...
path.join(process.cwd(), "services/fulfillment-svc/prisma/client/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-openssl-3.0.x.so.node");
path.join(process.cwd(), "services/fulfillment-svc/prisma/client/libquery_engine-linux-musl-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "services/fulfillment-svc/prisma/client/schema.prisma")
