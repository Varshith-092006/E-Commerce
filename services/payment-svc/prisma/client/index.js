...
const config = {
  ...
  "inlineSchemaHash": "e36e0ed741a0f3aff3234619c8b79f54a017d43a7485975a7e43e55531ae7a12",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "services/payment-svc/prisma/client",
    "payment-svc/prisma/client",
  ]
...
path.join(process.cwd(), "services/payment-svc/prisma/client/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-openssl-3.0.x.so.node");
path.join(process.cwd(), "services/payment-svc/prisma/client/libquery_engine-linux-musl-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "services/payment-svc/prisma/client/schema.prisma")
